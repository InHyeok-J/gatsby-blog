...
const Post = ({ data, pageContext }) => {
  console.log(pageContext, "페이지 정보");
  let HeaderElements;
      ...
      <PostLayout>
        ...
        <div className="date-tag">
          <span>
            ...
            <span className="date-tag-text">{data.mdx.frontmatter.date}</span>
          </span>
          <span>
            <FaTag className="icon" />
            <span className="date-tag-text">{data.mdx.frontmatter.tags}</span>
          </span>
        </div>
        ...
        <NextPage pageContext={pageContext} />
